function BandData = read(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MNTEAFMSCF = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   MNTEAFMSCF = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from

...
DFTFile='AFM_MnTeLi_DOS.csv';  %E: 1st column in eV, g: 2nd column in states/eV/atom
...
VBpoint=901;   %Index to VB edge in E vector
CBpoint=917;   %Index to CB edge in E vector

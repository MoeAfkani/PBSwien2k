...
if versus == 0;  %vs T
    ...
    TT=linspace(10,305,30); 
    T=TT(j)  %K
    Xvar=TT;
%     ND=-5.7e19*1e6; %m^-3 %MnTeLi0.003
    ND=-2.9e20*1e6; %m^-3 %MnTeLi0.003
%     ND=-4.49e20*1e6; %m^-3  %MnTeLi0.03
...
DFTFile='AFM_MnTe_DOS.csv';  %E: 1st column in eV, g: 2nd column in states/eV/atom
...
VBpoint=757;   %754 752 Index to VB edge in E vector
CBpoint=757;   %757 758 Index to CB edge in E vector
